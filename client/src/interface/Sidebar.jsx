...
export const Sidebar = () => {
  ...
  useEffect(() => {
    (sidebarIsOpen) ? toogleShow(true) : setTimeout(() => toogleShow(false), 250)
  }, [sidebarIsOpen])
      ...
      <div className="Sidebar">
        ...
        >
          ...
          <ul className="Sidebar__group">
            ...
            <li>
              <NavLink onClick={handleCloseSidebar} to="/categories">
                Categories
              </NavLink>
            </li>
            <li>
              <NavLink onClick={handleCloseSidebar} to="/products">
                Products
              </NavLink>
            </li>
          </ul>
          ...
          {(!isLoading && status === 'auth') && (
            <ul className="Sidebar__group">
              ...
              <li>
                <NavLink onClick={handleCloseSidebar} to="/account/orders">
                  My Orders
                </NavLink>
              </li>
            </ul>
