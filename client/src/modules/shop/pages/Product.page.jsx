    ...
    <>
      <section className="ProductSection">
        <img
          ...
          src={resize(activeProduct.image, 500)}
        ...
        <div className="ProductSection__content">
          ...
          <div className="ProductSection__prices">
            ...
            <span>
              ...
              {currencyFormatter(activeProduct.prices.wholesale)}
            </span>
          </div>
          ...
          <div className="ProductSection__controls">
            ...
            <div>
              <button className="fluid" onClick={onAddToShoppingCart}>
                Add to cart
              </button>
              {productCounter > 0 && (
                <button onClick={onRemoveToShoppingCart}>
                  <MdOutlineDelete />
                </button>
              )}
            </div>
      ...
      {/* <section className="Section">
        ...
        <article className="Section__content Section__content--products"></article>
      </section> */}
    </>
  )
}
