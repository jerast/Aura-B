...
import { getLastPath, getSessionToken } from '@/helpers'
    ...
    <section className={`Auth ${(isloggin) ? '' : 'Auth--sign-up'}`}>
      <div className="Auth__box">
        <form className="Auth__form" onSubmit={handleLoginFormSubmit}>
          <span className="ShoppingCart__close-button cursor-pointer fluid" onClick={handleGoBack}>
            <BiLeftArrowAlt />
          </span>
          ...
          <Button disabled={!isloggin} value="Continue" />
